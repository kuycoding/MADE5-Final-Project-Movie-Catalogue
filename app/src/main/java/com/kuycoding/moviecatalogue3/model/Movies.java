...
import com.kuycoding.moviecatalogue3.db.DatabaseContract;
...
import static com.kuycoding.moviecatalogue3.db.DatabaseContract.getColumnInt;
import static com.kuycoding.moviecatalogue3.db.DatabaseContract.getColumnString;
...
public class Movies implements Parcelable {
    ...
    public Movies(int id, String posterPath, String backdrop_path, String title, String releaseDate, double popularity, int voteCount, double voteAverage, String originalLanguage, ArrayList<Integer> genre, ArrayList<GenreModel> listGenreModel, ArrayList<String> listGenreString, String overview) {
        this.id = id;
    ...
    public Movies(int i, int id, String s, String title, double voteAverage, int vote_average, String overview, String release_date, String poster_path, double popular, String backdrop_path) {
    }
